...
class DDPGAgent(nn.Module):
    ...
    def save(self, prefix):
        torch.save(self.target_policy.state_dict(), prefix+'target_policy.pth')
        torch.save(self.target_critic.state_dict(), prefix+'target_critic.pth')
        
    def load(self, prefix):
        self.target_policy.load_state_dict(torch.load(prefix+'target_policy.pth'))
        self.target_critic.load_state_dict(torch.load(prefix+'target_critic.pth'))
        import copy
        self.policy = copy.deepcopy(self.target_policy)
        self.critic = copy.deepcopy(self.target_policy)
